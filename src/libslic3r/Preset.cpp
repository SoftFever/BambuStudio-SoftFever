...
static std::vector<std::string> s_Preset_filament_options {
    ...
    "fan_max_speed", "enable_overhang_bridge_fan", "overhang_fan_speed", "overhang_fan_speed_max", "overhang_fan_threshold", "bridge_fan_speed", "close_fan_the_first_x_layers", "full_fan_speed_layer", "fan_cooling_layer_time", "slow_down_layer_time", "slow_down_min_speed",
