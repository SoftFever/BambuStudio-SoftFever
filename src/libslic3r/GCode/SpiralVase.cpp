...
std::string SpiralVase::process_layer(const std::string &gcode, bool last_layer)
{
    ...
    float starting_flowrate  = float(m_config.spiral_starting_flow_rate.value / 100);
    float finishing_flowrate = float(m_config.spiral_finishing_flow_rate.value / 100);
